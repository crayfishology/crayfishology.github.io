...
(function() {
  ...
  var demoContent = [
    {
      demo_link: 'https://masonry.desandro.com/methods.html',
      img_link: 'https://imgur.com/a/huhzWnu',
      code_link: 'https://masonry.desandro.com/methods.html',
      title: 'Masonry: Waterfall',
      core_tech: 'JavaScript',
      description: '此页面使用的Javascript网格布局库'
    },
  ];
